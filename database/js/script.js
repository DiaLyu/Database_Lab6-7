$(document).ready(function(){
	    ...
	    if (! /^[0-9]+$/.test(text_input)) {
	    	...
	    	if (count_rows >= 1) {
	    		for (var i = 1; i <= count_rows; i++) {
	    			...
	    			table += "<td\><input class=\"row-"+ i +" null-chkb\" type=\"checkbox\"></td>";
	    			table += "<td><input class=\"row-"+ i +" uniq-chkb\" type=\"checkbox\"></td>";
	    			table += "<td><input class=\"row-"+ i +" autoincr-chkb\" type=\"checkbox\"></td>";
	    			table += "</tr>";
	    		}
	    	}
				table += "</tbody></table>"
	...
	$(".right-block").on("click", ".add-stb-btn", function(e) {
		...
		var table = "<div style=\"margin-left: 100px;\" class=\"table-add-table table-block\">";
  			...
  			table += "<td><input class=\"row-"+ 1 +" null-chkb\" type=\"checkbox\"></td>";
  			table += "<td><input class=\"row-"+ 1 +" uniq-chkb\" type=\"checkbox\"></td>";
  			table += "<td><input class=\"row-"+ 1 +" autoincr-chkb\" type=\"checkbox\"></td>";
  			table += "</tr>";
				table += "</tbody></table>"
				table += "</div>";
	...
	$(".sql-block-open, .sql-block-open-visible").on('click', function() {
		if (times == 0) {
			...
			$(".fa-arrow-alt-from-bottom").css("transition","0.5s").css("transform","rotate(180deg)");
